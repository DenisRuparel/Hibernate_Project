    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
      ...
      hs = request.getSession(true);
        try {
            ...
            List<Book> li = q.list();
            output = "<table border=1><tr><th>Id</th><th>Title</th><th>Catagory</th><th>Author</th><th>Price</th></tr>";
            for (Book b : li) {
                output += "<tr>";
                output += "<td>" + b.getId()+ "</td>";
                output += "<td>" + b.getBookTitle()+ "</td>";
                output += "<td>" + b.getCatagory() + "</td>";
                output += "<td>" + b.getAuthorName()+ "</td>";
                output += "<td>" + b.getPrice()+ "</td>";
                output += "</tr>";
            }
            output += "</table>";
